...
| `Out of host capacity` | isso é da OCI (Opção B), não da AWS | é o motivo de a Opção A (AWS) existir; ignore na trilha AWS |
...
| cadeado vermelho / `CERT_AUTHORITY_INVALID` | você está no cert **staging** | promova pro prod (README lab-03 §7) |
